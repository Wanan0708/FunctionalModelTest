...
public:
    ...
    QLineEdit* preferredSpeedEdit() const;
    QLineEdit* maxSpeedEdit() const;
    QLineEdit* maxAccelerationEdit() const;
    QLineEdit* maxDecelerationEdit() const;
    QLineEdit* maxTurnRateEdit() const;
    QLineEdit* radarCrossSectionEdit() const;
    ...
    QLineEdit* radarPeakPowerEdit() const;
    QLineEdit* radarAntennaGainEdit() const;
    QLineEdit* radarCenterFrequencyEdit() const;
    QLineEdit* radarBandwidthEdit() const;
    QLineEdit* radarNoiseFigureEdit() const;
    QLineEdit* radarSystemLossEdit() const;
    QLineEdit* radarRequiredSnrEdit() const;
    QLineEdit* radarProcessingGainEdit() const;
    QLineEdit* radarScanRateEdit() const;
    QLineEdit* radarReceiverTemperatureEdit() const;
...
private:
    ...
    QLineEdit* preferredSpeedEdit_ {nullptr};
    QLineEdit* maxSpeedEdit_ {nullptr};
    QLineEdit* maxAccelerationEdit_ {nullptr};
    QLineEdit* maxDecelerationEdit_ {nullptr};
    QLineEdit* maxTurnRateEdit_ {nullptr};
    QLineEdit* radarCrossSectionEdit_ {nullptr};
    ...
    QLineEdit* radarPeakPowerEdit_ {nullptr};
    QLineEdit* radarAntennaGainEdit_ {nullptr};
    QLineEdit* radarCenterFrequencyEdit_ {nullptr};
    QLineEdit* radarBandwidthEdit_ {nullptr};
    QLineEdit* radarNoiseFigureEdit_ {nullptr};
    QLineEdit* radarSystemLossEdit_ {nullptr};
    QLineEdit* radarRequiredSnrEdit_ {nullptr};
    QLineEdit* radarProcessingGainEdit_ {nullptr};
    QLineEdit* radarScanRateEdit_ {nullptr};
    QLineEdit* radarReceiverTemperatureEdit_ {nullptr};
